...
def test_cycle():
    A = structure_from_owl("tests/test-cycle.owl")
...
def test_hard():
    A = structure_from_owl("tests/test-hard-11.owl")
...
def test_father():
    A = structure_from_owl("tests/father.owl")
...
def test_fm_bench():
    A = structure_from_owl("tests/fm.owl")
...
def test_carcinogen():
    A = structure_from_owl("tests/carcinogenesis.owl")
...
def test_lymphography():
    A = structure_from_owl("tests/lymphography.owl")
...
def test_trains():
    A = structure_from_owl("tests/trains.owl")
...
def test_el_path5():
    A = structure_from_owl("tests/test-el-path-5.owl")
...
def test_el_tree15():
    A = structure_from_owl("tests/test-el-tree-15.owl")
...
def test_owl_bench():
    A = structure_from_owl("tests/OWL2EL-1.owl")

    P = ["http://benchmark/OWL2Bench#U0WC0D3UGWS9"]

    N = [
        "http://benchmark/OWL2Bench#U0WC0D3VP0",
    ]
...
def test_resoning1():
    ...
    assert fitting_exists(Ab.A, ["a", "c"], ["b"])
